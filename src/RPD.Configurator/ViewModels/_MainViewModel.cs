...
namespace RPD.Configurator.ViewModels
{
    ...
    {
        ObservableCollectionsLinker<IRpdMeter, RpdMeterViewModel> rpdMetersLinker;
        ...
        private void updatePropertyBindings()
        {
        ...
        public int NetAddress
        {
            get
            {
                return deviceConfiguration.NetAddress;
            }
        ...
        public bool ResetFaultsDump
        {
            get
            {
                return deviceConfiguration.ResetFaultsDump;
            }
        ...
        public bool SaveByteInterval
        {
            get
            {
                return deviceConfiguration.SaveByteInterval;
            }
        ...
        public int SectionNumber
        {
            get
            {
                return deviceConfiguration.SectionNumber - 1;
            }
        ...
        {
            get { return deviceConfiguration.Diagnostic.FirmwareVersion.ToString(); }
        }
